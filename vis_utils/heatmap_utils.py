...
def compute_from_patches(wsi_object, clam_pred=None, model=None, batch_size=512,  
    ...
    roi_loader = get_simple_loader(roi_dataset, batch_size=batch_size, num_workers=1)
